package com.seventhmoon.smartcontrol.serial
...
import com.seventhmoon.smartcontrol.data.Constants
    ...
    private fun createNotification() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val nc = NotificationChannel(
                Constants.BluetoothService.NOTIFICATION_CHANNEL,
                "Background service",
        ...
        val disconnectIntent = Intent()
            .setAction(Constants.BluetoothService.INTENT_ACTION_DISCONNECT)
        val restartIntent = Intent()
            .setClassName(this, Constants.BluetoothService.INTENT_CLASS_MAIN_ACTIVITY)
        ...
        val builder: NotificationCompat.Builder =
            NotificationCompat.Builder(this, Constants.BluetoothService.NOTIFICATION_CHANNEL)
        ...
        startForeground(Constants.BluetoothService.NOTIFY_MANAGER_START_FOREGROUND_SERVICE, notification)
    }
        ...
        if (connected) {
            synchronized(this) {
                if (listener != null) {
                    ...
                    if (queue2!!.isEmpty() || queue2!!.getLast().type != QueueType.Read) queue2!!.add(
